...
class edit_course_page implements \renderable, \templatable {
    ...
    public function export_for_template(\renderer_base $output) {
        ...
        foreach (\mod_stratumtwo_category::getCategoriesInCourse($this->courseid, true) as $cat) {
        ...
        foreach (\mod_stratumtwo_exercise_round::getExerciseRoundsInCourse($this->courseid, true) as $exround) {
