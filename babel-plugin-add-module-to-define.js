 ...
 * exported.
 *
 * Changes: Adapted from Moodle 3.10 so that it can be used in the plugin directory
 * without the whole Moodle source code directory.
 *
