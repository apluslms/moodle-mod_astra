...
$title = get_string('exportdata', mod_stratumtwo_exercise_round::MODNAME);

$PAGE->set_pagelayout('incourse');
$PAGE->set_url(\mod_stratumtwo\urls\urls::exportIndex($cid, true));
...
$exportNav = $courseNav->add($title,
        \mod_stratumtwo\urls\urls::exportIndex($cid, true),
...
$renderable = new \mod_stratumtwo\output\export_index_page($cid);
