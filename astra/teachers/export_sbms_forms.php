...
$title = get_string('exportsubmittedform', mod_astra_exercise_round::MODNAME);

$PAGE->set_pagelayout('incourse');
$PAGE->set_url(\mod_astra\urls\urls::exportSubmittedFormInput($cid, true));
...
$exportNav = $courseNav->add($title,
        \mod_astra\urls\urls::exportSubmittedFormInput($cid, true),
...
if ($fromform = $form->get_data()) {
    ...
    echo '<p>'. get_string('exportsubmittedformdesc', mod_astra_exercise_round::MODNAME) .'</p>';
