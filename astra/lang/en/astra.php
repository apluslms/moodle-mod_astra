...
// Privacy API
$string['privacy:metadata:core_files'] = 'Astra stores files that users have uploaded to exercise submissions.';
$string['privacy:metadata:core_message'] = 'Messages are sent to users about new assistant feedback on their submissions.';
$string['privacy:metadata:astra_submissions'] = 'Submissions to exercises contain the data submitted by the user, their grade and feedback, and the submission time.';
$string['privacy:metadata:astra_submissions:submitter'] = 'The user ID of the submitter.';
$string['privacy:metadata:astra_submissions:submissiontime'] = 'The time when the submission was uploaded.';
$string['privacy:metadata:astra_submissions:exerciseid'] = 'The ID of the exercise that the submission is for.';
$string['privacy:metadata:astra_submissions:feedback'] = 'Feedback for the submission.';
$string['privacy:metadata:astra_submissions:assistfeedback'] = 'Feedback for the submission written by a teacher.';
$string['privacy:metadata:astra_submissions:grade'] = 'The grade (or points) of the submission.';
$string['privacy:metadata:astra_submissions:gradingtime'] = 'The time when the submission was graded.';
$string['privacy:metadata:astra_submissions:latepenaltyapplied'] = 'Late submission penalty applied to the submission.';
$string['privacy:metadata:astra_submissions:servicepoints'] = 'The original points granted to the submission in the grading scale used by the exercise service.';
$string['privacy:metadata:astra_submissions:submissiondata'] = 'The user submitted data of the submission, such as text entered to a form.';
$string['privacy:metadata:astra_submissions:gradingdata'] = 'Grading data for the submission generated by the grader.';
$string['privacy:metadata:astra_dl_deviations'] = 'Personal exercise deadline extensions given to users.';
$string['privacy:metadata:astra_dl_deviations:submitter'] = 'The user ID whom the extension is for.';
$string['privacy:metadata:astra_dl_deviations:exerciseid'] = 'The ID of the exercise affected by the extension.';
$string['privacy:metadata:astra_dl_deviations:extraminutes'] = 'The duration of the deadline extension.';
$string['privacy:metadata:astra_maxsbms_devs'] = 'Personal exercise submission limit extensions given to users.';
$string['privacy:metadata:astra_maxsbms_devs:submitter'] = 'The user ID whom the extension is for.';
$string['privacy:metadata:astra_maxsbms_devs:exerciseid'] = 'The ID of the exercise affected by the extension.';
$string['privacy:metadata:astra_maxsbms_devs:extrasubmissions'] = 'The number of extra submissions granted.';
