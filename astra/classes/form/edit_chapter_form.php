 ...
 */
class edit_chapter_form extends \mod_astra\form\edit_learning_object_form {
    ...
    public function definition() {
        ...
        $mform->addElement('advcheckbox', 'generatetoc',
                \get_string('generatetoc', \mod_astra_exercise_round::MODNAME),
                '', null, array(0, 1));
        $mform->addHelpButton('generatetoc', 'generatetoc', \mod_astra_exercise_round::MODNAME);
