...
abstract class edit_learning_object_form extends \moodleform {
    ...
    /**
     * Constructor.
     * @param \mod_stratumtwo_exercise_round $exround current exercise round of an existing learning object or
     ...
     */
    public function __construct(\mod_stratumtwo_exercise_round $exround, $editObjectId = 0, $action = null) {
    ...
    function validation($data, $files) {
        ...
        foreach ($lobjRecords as $exrecord) {
            if (isset($exrecord->maxsubmissions)) {
                $otherObject = new \mod_stratumtwo_exercise($exrecord);
            } else {
                $otherObject = new \mod_stratumtwo_chapter($exrecord);
            }
