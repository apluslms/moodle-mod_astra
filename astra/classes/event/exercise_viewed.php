...
/* Event class: user viewed an Astra exercise.
 */
/*
...
class exercise_viewed extends \core\event\base {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = \mod_astra_learning_object::TABLE; // DB table
    }

    /* Return localised name of the event, it is the same for all instances.
     */
    public static function get_name() {
        return get_string('eventexerciseviewed', \mod_astra_exercise_round::MODNAME);
    }

    /* Returns non-localised description of one particular event.
     */
    public function get_description() {
        return "The user with the id '$this->userid' viewed an Astra exercise (id = {$this->objectid}).";
    }
    ...
    public static function get_objectid_mapping() {
        return array('db' => \mod_astra_learning_object::TABLE, 'restore' => 'learningobject');
    }
}
